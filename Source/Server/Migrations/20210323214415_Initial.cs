        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StateReason = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LikeRequests", x => new { x.RequestId, x.SystemUserId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "60c51d0e-6c24-4191-970b-aefb93fb9c51", "ad2d8f32-0c7c-4957-a033-73310f5dac37", "admin", "admin" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "adce8478-150e-4f7a-8dff-22bf15a0be0f", "51308929-5fd5-4f3b-87d3-969e87337248", "user", "user" });
